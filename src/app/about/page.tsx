          ...
          <CardContent className="space-y-6">
            <div className="prose prose-slate dark:prose-invert max-w-none">
              ...
              <p 
                ...
                className="text-foreground leading-relaxed"
              >
                The template includes everything you need to get started quickly: 
                theme switching, responsive design, beautiful components from 
                shadcn/ui, smooth animations with Framer Motion, and a scalable 
